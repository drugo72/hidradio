REM $Id: arm_iar_build_all_example_apps.bat 25610 2011-02-17 05:37:07Z ravikumar.vanteddu $
...
CALL arm_iar_build_mac_example_3_beacon_payload.bat >> arm_iar_build_all_example_apps.log 2>> arm_iar_build_all_example_apps.err
CALL arm_iar_build_mac_example_4_beacon_bc_data.bat >> arm_iar_build_all_example_apps.log 2>> arm_iar_build_all_example_apps.err
CALL arm_iar_build_mac_example_6_beacon_indirect_bc_data.bat >> arm_iar_build_all_example_apps.log 2>> arm_iar_build_all_example_apps.err
...
REM CALL arm_iar_build_stb_example_secure_star_network.bat >> arm_iar_build_all_example_apps.log 2>> arm_iar_build_all_example_apps.err
