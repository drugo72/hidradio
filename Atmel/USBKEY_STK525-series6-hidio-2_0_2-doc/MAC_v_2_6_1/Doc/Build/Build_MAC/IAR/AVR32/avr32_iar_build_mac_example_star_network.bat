REM $Id: avr32_iar_build_mac_example_star_network.bat 25610 2011-02-17 05:37:07Z ravikumar.vanteddu $
...
REM    AT86RF212_AT32UC3A3256_RZ600
    ...
    cd ..\..\..\..\Applications\MAC_Examples\Star_Nobeacon\AT86RF212_AT32UC3A3256_RZ600\IAR

    %avr32_iarbuild% Star.ewp -clean Release
    %avr32_iarbuild% Star.ewp -build Release
...
REM     AT86RF230B_AT32UC3A3256_RZ600
    ...
    cd ..\..\..\..\Applications\MAC_Examples\Star_Nobeacon\AT86RF230B_AT32UC3A3256_RZ600\IAR
...
REM     AT86RF231_AT32UC3A3256_RZ600
    ...
    cd ..\..\..\..\Applications\MAC_Examples\Star_Nobeacon\AT86RF231_AT32UC3A3256_RZ600\IAR
