REM $Id: build_all_example_apps.bat 25610 2011-02-17 05:37:07Z ravikumar.vanteddu $
...
CALL build_mac_example_6_beacon_indirect_bc_data.bat >> build_all_example_apps.log 2>> build_all_example_apps.err
...
REM CALL build_pal_example_led_control.bat >> build_all_example_apps.log 2>> build_all_example_apps.err
...
REM CALL build_stb_example_secure_star_network.bat >> build_all_example_apps.log 2>> build_all_example_apps.err
