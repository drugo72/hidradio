 ...
 * @file pal_config.h
 *
 * @brief PAL configuration for DERF_USB_13E00
 *
 * This header file contains configuration parameters for AT91SAM7S256.
 *
 * $Id: pal_config.h 25440 2011-02-08 13:52:04Z mahendran.p $
 *
 */
/**
 * @author
...
#define TRX_INT_PIN   {1 << 19, PIOA, ID_PIOA, PIO_INPUT, PIO_DEGLITCH | PIO_IT_RISE_EDGE}
#define	TRX_RXTS_PIN  {1 << 20, PIOA, ID_PIOA, PIO_INPUT, PIO_DEGLITCH | PIO_IT_RISE_EDGE}
...
/*
 * SPI Base Register:
 * SPI0 is used by DERF_USB_23E001
 */
#define SPI_USED             (SPI)
 ...
 */
#define ENTER_TRX_REGION() {uint32_t irq_mask=__get_PRIMASK(); DISABLE_TRX_IRQ()
 ...
 */
#define LED_PINS                (PIO_PA16 | PIO_PA17 | PIO_PA18)
