 ...
 *
 * $Id: pal_board.c 25456 2011-02-09 06:23:24Z mahendran.p $
 *
 *  @author
...
#if (BOARD_TYPE == RZ600_230_SAM3SEK)
/* === Macros =============================================================== */
...
void timer_init_non_generic(void)
{
    ...
    initialize_timer_channel((TC_CLKS_MCK32| TC_CMR0_WAVE | TC_CMR0_ACPA_SET | (0x1 << 13)
                             | TC_CMR0_ACPC_CLEAR), &TC0->TC_CHANNEL[TIMER_CHANNEL_0]);
...
void pal_led_init(void)
{
    ...
    PIN_SET_AS_PIO_OUTPUT((PIO_PC20), PIO_C);
...
void trx_interface_init(void)
{
     ...
     */
    PIN_SET_AS_PIO_OUTPUT(SEL, PIO_B);
...
#endif /* #if (BOARD_TYPE == RZ600_230_SAM3SEK)*/
