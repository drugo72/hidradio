 ...
 * @file pal_timer.c
 *
 * @brief Timer related functions for SAM3 MCUs
 *
 * This file implements timer related functions for SAM3 MCUs.
 *
 * $Id: pal_timer.c 24759 2011-01-06 13:50:26Z mahendran.p $
 *
