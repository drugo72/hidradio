 ...
 *
 * $Id: pal_irq.c 25716 2011-02-24 07:17:04Z v_prasad.anjangi $
 *
...
#ifdef NO_32KHZ_CRYSTAL
    /* Comes here if MCU was in sleep.
     * Switch the Watchdog from Interrupt mode to system reset mode here
    */
    WDT_SYSTEM_RESET_MODE(WDTO_4S);
    pal_led(LED_1, LED_ON);
#endif /* NO_32KHZ_CRYSTAL */
}
#endif
