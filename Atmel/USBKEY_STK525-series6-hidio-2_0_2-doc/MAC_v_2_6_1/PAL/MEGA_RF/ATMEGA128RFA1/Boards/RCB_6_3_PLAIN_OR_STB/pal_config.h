 ...
 *
 * $Id: pal_config.h 24878 2011-01-13 06:29:59Z felix.varghese $
 *
...
/* Enumerations used to Indentify the board types */
typedef enum
{
    PLAIN,
    SENSOR_TERM_BOARD
 ...
 * PORT where LEDs are connected
 */
#define LED_PORT_PLAIN                   (PORTE) /**< Port for LEDs */
#define LED_PORT_DIR_PLAIN               (DDRE)  /**< Port directions for LEDs */

/*
 * PINs where LEDs are connected
 */
#define LED_PIN_PLAIN_0                  (PE2)   /**< LED 0 pin */
#define LED_PIN_PLAIN_1                  (PE3)   /**< LED 1 pin */
#define LED_PIN_PLAIN_2                  (PE4)   /**< LED 2 pin */
 ...
 */
#define BUTTON_PORT_PLAIN                     (PORTE) /**< Port for buttons */
#define BUTTON_PORT_DIR_PLAIN                 (DDRE)  /**< Port directions for buttons */
#define BUTTON_INPUT_PINS_PLAIN               (PINE)  /**< Input pins for buttons */

/*
 * PINs where buttons are connected
 */
#define BUTTON_PIN_PLAIN_0                    (PE5)   /**< Button 0 pin */
...
uint8_t pal_xram_read(uint16_t);
