 ...
 *
 * $Id: pal_config.h 24834 2011-01-11 13:25:29Z v_prasad.anjangi $
 *
...
/* MAcros to define the time-period to be set for the sleeping timer (RTC)*/
#define RTC_CYCLES_8ms        			  (8)
#define RTC_CYCLES_16ms       			  (16)
#define RTC_CYCLES_32ms       			  (32)
#define RTC_CYCLES_64ms       			  (64)
#define RTC_CYCLES_125ms      			  (128)
#define RTC_CYCLES_250ms      			  (256)
#define RTC_CYCLES_500ms      			  (512)
#define RTC_CYCLES_1000ms     			  (1024)
#define RTC_CYCLES_2000ms     			  (2048)
#define RTC_CYCLES_4000ms     			  (4096)
#define RTC_CYCLES_8000ms     			  (8192)
...
/*Time-period to be set for the Parallel software timer*/
...
/* MAcros to define the time-period to be set for the Watchdog Timer*/
#define WDT_8ms_expiry                    WDT_PER_8CLK_gc *
#define WDT_16ms_expiry	                  WDT_PER_16CLK_gc
#define WDT_32ms_expiry	                  WDT_PER_32CLK_gc
#define WDT_64ms_expiry	                  WDT_PER_64CLK_gc
#define WDT_125ms_expiry	              WDT_PER_125CLK_gc
#define WDT_250ms_expiry	              WDT_PER_250CLK_gc
#define WDT_500ms_expiry	              WDT_PER_500CLK_gc
#define WDT_1000ms_expiry	              WDT_PER_1KCLK_gc
#define WDT_2000ms_expiry	              WDT_PER_2KCLK_gc
#define WDT_4000ms_expiry                 WDT_PER_4KCLK_gc
#define WDT_8000ms_expiry	              WDT_PER_8KCLK_gc
