 ...
 *
 * $Id: pal_irq.c 24830 2011-01-11 12:14:23Z jignesh.vaghela $
 *
...
void pal_trx_irq_init(FUNC_PTR trx_irq_cb)
{
     ...
     */
     ...
     gpio_port->gfers = mask;   //Glitch Filter is Enabled
     gpio_port->imr0s = mask;  //Rising Edge
     gpio_port->imr1c = mask;  //Rising Edge
     gpio_port->ifrc = mask;  // Interrupt Flag Register
}
