 ...
 * @file pal_config.h
 *
 * @brief PAL configuration for AVR32 AT32UC3L064
 *
 * This header file contains configuration parameters for AVR32 AT32UC3L064.
 *
 * $Id: pal_config.h 25880 2011-03-08 05:56:34Z yogesh.bellan $
 *
...
/* === Externals ============================================================*/
    ...
    extern const unsigned int ipr_val[1 << AVR32_INTC_IPR_INTLEVEL_SIZE];
#endif
...
#define CLOCK_DIVIDER       (0x03)//(0x05)
 ...
 */
#define BUTTON_PIN_0                    (AVR32_PIN_PA20)   /* Button 0 pin */

/*
 * RESET pin of transceiver
 */
#define TRX_RST                         (AVR32_PIN_PB02)

/*
 * Sleep Transceiver pin
 */
#define SLP_TR                        (AVR32_PIN_PB00)
...
/*
 * SPI Pins settings for ATAVR32UC3L064 & AT86RF231
 */
#define RF_SPI_DIV                      (5)
...
/*
 * UART related settings for ATAVR32UC3L064
 */
...
/*
 * Timer related settings for ATAVR32UC3L064
 */
...
/* Disables the timetatmp interrupts */
