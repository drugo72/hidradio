 ...
 *
 * $Id: pal_irq.c 25915 2011-03-11 11:52:24Z yogesh.bellan $
 *
...
#endif
#ifndef WATCHDOG
    rtc_set_top_value(&AVR32_RTC, RTC_TOP_VALUE_4s);
#else
...
/**
 * @brief Interrupt handler of the External interrupt line.
 */
extern eic_options_t eic_options[EXT_INT_NUM_OF_LINES];
#if __GNUC__
__attribute__((__interrupt__))
#elif __ICCAVR32__
#pragma handler = EXTERNAL_INTERRUPT_ISR_GROUP, EXTERNAL_INTERRUPT_PRIORITY
__interrupt
#endif
void eic_int_handler(void)
{
    eic_clear_interrupt_line(&AVR32_EIC, AVR32_EIC_INT4);
