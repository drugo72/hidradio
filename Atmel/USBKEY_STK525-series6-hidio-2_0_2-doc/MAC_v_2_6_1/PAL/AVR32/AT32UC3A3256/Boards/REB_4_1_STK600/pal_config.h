 ...
 *
 * $Id: pal_config.h 24813 2011-01-11 09:24:18Z jignesh.vaghela $
 *
...
#define USART_RX                             (AVR32_USART0_RXD_0_0_PIN)         //RXD-PA03 on STK600
#define USART_RX_FUNCTION                    (AVR32_USART0_RXD_0_0_FUNCTION)
#define USART_TX                             (AVR32_USART0_TXD_0_0_PIN)         //TXD-PA04 on STK600
...
#define USART_ISR_PRIORITY                   (1)
#define USART_RX                             (AVR32_USART1_RXD_0_0_PIN)         //RXD-PA05 on STK600
#define USART_RX_FUNCTION                    (AVR32_USART1_RXD_0_0_FUNCTION)
#define USART_TX                             (AVR32_USART1_TXD_0_0_PIN)         //TXD-PA06 on STK600
