 ...
 *
 * $Id: pal_config.h 24774 2011-01-07 15:14:08Z sschneid $
 *
...
#if (BOARD_TYPE == REB_5_0_STK500_STK501)
...
/** Disables the RX TIME STAMP interrupt. */
...
/*
 * IRQ pin is PORTD 0 (aka. INT0)
 */
#define IRQ_PINGET()                    (PIND & _BV(PD0))
