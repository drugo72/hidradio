 ...
 *
 * $Id: tal_ed.c 24223 2010-11-16 14:39:15Z jwunsch $
 *
...
retval_t tal_ed_start(uint8_t scan_duration)
{
     ...
     */
    pal_trx_irq_dis();     /* Enable main transceiver interrupt. */
    ...
    pal_trx_bit_write(SR_IRQ_MASK, TRX_IRQ_CCA_ED_DONE); /* Enable interrupt */
