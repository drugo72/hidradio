 ...
 * @file main.c
 *
 * @brief MAC Example App 6 Beacon Indirect Traffic and Broadcast Data - Coordinator
 *
...
#define APP_INDIRECT_DATA_DURATION_MS   (3000)
...
int main(void)
{
    ...
    printf("\nApp_6_Beacon_Indirect_Traffic_and_Broadcast_Data\n\n");
    printf("\nCoordinator\n\n");
#endif /* SIO_HUB */
