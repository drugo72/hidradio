 ...
 *
 * $Id: main.c 25539 2011-02-11 11:22:06Z yogesh.bellan $
 *
...
#define DEFAULT_PAN_ID                  CCPU_ENDIAN_TO_LE16(0xBEEF)
        ...
        else    /* ROOT or ROUTER */
        {
            ...
            else    /* ROOT */
            {
                ...
                if (msduLength > 9)
                {
                    ...
                    for (i = 0; i < 8; i++)
                    {
                        sprintf(ascii, "%.2" PRIX8 " ", msdu[7-i]);
                        printf(ascii);
                    }
...
/**
 * Node selction for ROOT,ROUTER or LEAF
 *
 * @return none
 */
static void node_type_selection(void)
