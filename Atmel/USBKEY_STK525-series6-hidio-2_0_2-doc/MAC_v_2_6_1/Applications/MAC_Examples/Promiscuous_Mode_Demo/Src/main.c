 ...
 * @file main.c
 *
 * @brief  MAC Example - Promiscuous Mode Demo
 *
 * This is the source code of a demo application for
 * promiscuous mode. Once the node is put into
 * promiscuous mode it will be able to receive valid frames
