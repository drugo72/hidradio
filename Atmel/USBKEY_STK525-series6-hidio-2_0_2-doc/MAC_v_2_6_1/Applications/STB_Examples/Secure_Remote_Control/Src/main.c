 ...
 *
 * $Id: main.c 25408 2011-02-07 13:23:43Z yogesh.bellan $
 *
...
static void security_type_selection();
...
static void tx_frame(bool security)
{
    ...
    /* Source Address */
    temp_value_16 = CCPU_ENDIAN_TO_LE16(OWN_SHORT_ADDR);
    frame_ptr -= 2;
...
static void configure_pibs(void)
{
     ...
     */
    temp_value_16 = CCPU_ENDIAN_TO_LE16(DEFAULT_PAN_ID);
...
/**
 * Security selction by button press
 *
 * @return none
 */
static void security_type_selection(void)
{
    ...
    {
        /*
         * Button was not pressed during board start-up.
         * To make sure the flag has the default value.
         */
         use_security = true;
    }
}
